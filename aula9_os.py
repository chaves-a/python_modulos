...
# digitou pwd no terminal para pegar o caminho que está sendo usado no momento
print(os.path.exists('/home/chaves-a/Documentos/Udemy/curso_python/python_modulos'))
print(os.path.abspath('.'))  # pega o caminho que está sendo usado no momento
print(caminho)
